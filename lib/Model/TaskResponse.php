...
class TaskResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'string',
        'assigner' => '\OpenAPI\Client\Model\PersonResponse',
        ...
        'date_of_last_update' => '\OpenAPI\Client\Model\TimePoint',
        'duration' => 'int',
    ...
    protected static $setters = [
        ...
        'has_start_date' => 'setHasStartDate',
        'has_end_date' => 'setHasEndDate',
        'has_start_time' => 'setHasStartTime',
        'has_end_time' => 'setHasEndTime',
        'delayed_till_date' => 'setDelayedTillDate',
        'date_of_last_update' => 'setDateOfLastUpdate',
    ...
    protected static $getters = [
        ...
        'has_start_date' => 'getHasStartDate',
        'has_end_date' => 'getHasEndDate',
        'has_start_time' => 'getHasStartTime',
        'has_end_time' => 'getHasEndTime',
        'delayed_till_date' => 'getDelayedTillDate',
        'date_of_last_update' => 'getDateOfLastUpdate',
    ...
    public const TYPE_CHECKMARK = 'Checkmark';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('has_start_date', $data ?? [], null);
        $this->setIfExists('has_end_date', $data ?? [], null);
        $this->setIfExists('has_start_time', $data ?? [], null);
        $this->setIfExists('has_end_time', $data ?? [], null);
        $this->setIfExists('delayed_till_date', $data ?? [], null);
        $this->setIfExists('date_of_last_update', $data ?? [], null);
    ...
    */
    ...
    public function setSourceDataVersion($source_data_version)
    {
        ...
        if ((mb_strlen($source_data_version) > 100)) {
            throw new \InvalidArgumentException('invalid length for $source_data_version when calling TaskResponse., must be smaller than or equal to 100.');
        }
     ...
     * Sets assigner
     *
     * @param \OpenAPI\Client\Model\PersonResponse|null $assigner assigner
     *
     * @return self
     */
    ...
    {
        return $this->container['has_start_date'];
    }

    /**
     * Sets has_start_date
     *
     * @param bool|null $has_start_date has_start_date
     *
     * @return self
     */
    public function setHasStartDate($has_start_date)
    {
        if (is_null($has_start_date)) {
            throw new \InvalidArgumentException('non-nullable has_start_date cannot be null');
        }
        $this->container['has_start_date'] = $has_start_date;
    ...
    {
        return $this->container['has_start_time'];
    }

    /**
     * Sets has_start_time
     *
     * @param bool|null $has_start_time has_start_time
     *
     * @return self
     */
    public function setHasStartTime($has_start_time)
    {
        if (is_null($has_start_time)) {
            throw new \InvalidArgumentException('non-nullable has_start_time cannot be null');
        }
        $this->container['has_start_time'] = $has_start_time;
    ...
    {
        return $this->container['has_end_time'];
    }

    /**
     * Sets has_end_time
     *
     * @param bool|null $has_end_time has_end_time
     *
     * @return self
     */
    public function setHasEndTime($has_end_time)
    {
        if (is_null($has_end_time)) {
            throw new \InvalidArgumentException('non-nullable has_end_time cannot be null');
        }
        $this->container['has_end_time'] = $has_end_time;
    ...
    /**
     * Gets date_of_last_update
     *
     * @return \OpenAPI\Client\Model\TimePoint|null
     */
    public function getDateOfLastUpdate()
    {
        return $this->container['date_of_last_update'];
    }

    /**
     * Sets date_of_last_update
     *
     * @param \OpenAPI\Client\Model\TimePoint|null $date_of_last_update date_of_last_update
     *
     * @return self
     */
    public function setDateOfLastUpdate($date_of_last_update)
    {
        if (is_null($date_of_last_update)) {
            throw new \InvalidArgumentException('non-nullable date_of_last_update cannot be null');
        }
        $this->container['date_of_last_update'] = $date_of_last_update;
