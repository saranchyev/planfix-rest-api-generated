 ...
 */
class CommentResponseChangeStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommentResponse_changeStatus';
    ...
    {
        $this->setIfExists('new_status_id', $data ?? [], null);
        $this->setIfExists('old_status_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets new_status_id
     *
     * @param int|null $new_status_id new_status_id
     *
     * @return self
     */
    public function setNewStatusId($new_status_id)
    {
        if (is_null($new_status_id)) {
            throw new \InvalidArgumentException('non-nullable new_status_id cannot be null');
        }
     ...
     * Sets old_status_id
     *
     * @param int|null $old_status_id old_status_id
     *
     * @return self
     */
    public function setOldStatusId($old_status_id)
    {
        if (is_null($old_status_id)) {
            throw new \InvalidArgumentException('non-nullable old_status_id cannot be null');
        }
