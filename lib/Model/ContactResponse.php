...
class ContactResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'supervisors' => '\OpenAPI\Client\Model\PeopleResponse',
        'phones' => '\OpenAPI\Client\Model\PhoneResponse[]',
        'companies' => '\OpenAPI\Client\Model\Company[]',
        'contacts' => '\OpenAPI\Client\Model\PersonResponse[]',
    ...
    protected static array $openAPINullables = [
		...
		'site' => false,
		'email' => false,
		'additional_email_addresses' => false,
		'skype' => false,
		'telegram_id' => false,
		'telegram' => false,
		'facebook' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('additional_email_addresses', $data ?? [], null);
    ...
    */
    ...
    public function setSourceDataVersion($source_data_version)
    {
        ...
        if ((mb_strlen($source_data_version) > 100)) {
            throw new \InvalidArgumentException('invalid length for $source_data_version when calling ContactResponse., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param string[]|null $additional_email_addresses additional_email_addresses
     *
     * @return self
     */
    public function setAdditionalEmailAddresses($additional_email_addresses)
    {
        if (is_null($additional_email_addresses)) {
            throw new \InvalidArgumentException('non-nullable additional_email_addresses cannot be null');
        }
     ...
     * Sets supervisors
     *
     * @param \OpenAPI\Client\Model\PeopleResponse|null $supervisors supervisors
     *
     * @return self
     */
     ...
     * Gets phones
     *
     * @return \OpenAPI\Client\Model\PhoneResponse[]|null
     */
     ...
     * Sets phones
     *
     * @param \OpenAPI\Client\Model\PhoneResponse[]|null $phones phones
     *
     * @return self
     */
     ...
     * Sets companies
     *
     * @param \OpenAPI\Client\Model\Company[]|null $companies companies
     *
     * @return self
     */
     ...
     * Sets contacts
     *
     * @param \OpenAPI\Client\Model\PersonResponse[]|null $contacts contacts
     *
     * @return self
     */
