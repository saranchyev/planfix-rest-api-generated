 ...
 */
class TaskUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSourceDataVersion($source_data_version)
    {
        ...
        if ((mb_strlen($source_data_version) > 100)) {
            throw new \InvalidArgumentException('invalid length for $source_data_version when calling TaskUpdateRequest., must be smaller than or equal to 100.');
        }
