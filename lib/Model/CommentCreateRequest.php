 ...
 */
class CommentCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommentCreateRequest';
    ...
    */
    ...
    public function setSourceDataVersion($source_data_version)
    {
        ...
        if ((mb_strlen($source_data_version) > 100)) {
            throw new \InvalidArgumentException('invalid length for $source_data_version when calling CommentCreateRequest., must be smaller than or equal to 100.');
        }
