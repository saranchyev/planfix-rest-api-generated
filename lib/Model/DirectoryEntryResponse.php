 ...
 */
class DirectoryEntryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectoryEntryResponse';
    ...
    protected static $openAPITypes = [
        'directory' => '\OpenAPI\Client\Model\Directory',
        'key' => 'int',
        'parent_key' => 'int',
        'archived' => 'bool',
        'is_group' => 'bool',
    ...
    */
     ...
     * Gets directory
     *
     * @return \OpenAPI\Client\Model\Directory|null
     */
     ...
     * Sets directory
     *
     * @param \OpenAPI\Client\Model\Directory|null $directory directory
     *
     * @return self
     */
     ...
     * Sets parent_key
     *
     * @param int|null $parent_key parent_key
     *
     * @return self
     */
    public function setParentKey($parent_key)
    {
        if (is_null($parent_key)) {
            throw new \InvalidArgumentException('non-nullable parent_key cannot be null');
        }
